...
png("plot3.png", width=480, height=480) ##The default already is 480x480, but I specify anyway because I don't want to lose points if someone doesn't know that
...
legend("topright", lty=c(1,1), col=c("black", "red", "blue"), legend=legendNames)
dev.off()
